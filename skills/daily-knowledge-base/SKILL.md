...
- [ ] 六段结构或诚实空档/骨架说明；不套用日报的“今日总结/存在问题/明日待办”结构
- [ ] 每张方法卡都写背景、原因、方法、参考；方法段有改前/改后代码或 unified diff，没有就明确标记待补
- [ ] 至少一轮完整实验环：假设、预期、Setup、Result、判断更新；关键字段有出处
- [ ] 无材料索引 / dump / 主机台账章节；主机覆盖限制只在自包含声明或仍未知中简述
- [ ] 结论有主张、前提、证据、不适用条件和置信度；本机终稿存在
